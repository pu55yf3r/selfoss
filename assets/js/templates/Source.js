...
export default function Source({source = null, spouts}) {
    ...
    return (
        <form data-source-id={sourceId}
            ...
            <div class="source-title">{source !== null ? source.title : selfoss.ui._('source_new')}</div>
            ...
            <ul class="source-edit-form">
                ...
                <li>
                    ...
                    <input id={`title-${sourceId}`} type="text" name="title" accesskey="t" value={source !== null ? source.title : ''} placeholder={selfoss.ui._('source_autotitle_hint')} />
                </li>
                ...
                <li>
                    ...
                    <input id={`tags-${sourceId}`} type="text" name="tags" accesskey="g" value={source !== null ? source.tags.join(',') : ''} />
